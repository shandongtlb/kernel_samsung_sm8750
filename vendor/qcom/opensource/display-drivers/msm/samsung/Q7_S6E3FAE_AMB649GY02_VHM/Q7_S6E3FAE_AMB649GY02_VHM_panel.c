...
*/
#include "Q7_S6E3FAE_AMB649GY02_VHM_panel.h"
#include "Q7_S6E3FAE_AMB649GY02_VHM_mdnie.h"
...
#if 0 //Unblock when GLUT enabled
...
void Q7_S6E3FAE_AMB649GY02_VHM_HD_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->h_buf = Q7_S6E3FAE_AMB649GY02_VHM_PDF_DATA;
	vdd->h_size = sizeof(Q7_S6E3FAE_AMB649GY02_VHM_PDF_DATA);
