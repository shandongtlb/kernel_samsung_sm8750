 ...
 * @off_work_in_progress:	Encoder Off work is in progress
 ...
 * @cesta_scc_override:	        Boolean indicating SCC CTRL settings have been overriden.
 */
