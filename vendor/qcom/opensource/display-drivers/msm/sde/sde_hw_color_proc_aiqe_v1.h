...
/**
 * sde_setup_aiqe_ssrc_config_v1 - api to setup SSRC config for SSRC V1
 * @ctx: pointer to dspp information structure
 * @cfg: pointer to sde_hw_cp_cfg payload
 * @mdnie_top: Pointer to top level mdnie structure
 */
void sde_setup_aiqe_ssrc_config_v1(struct sde_hw_dspp *ctx, void *cfg, void *mdnie_top);

/**
 * sde_setup_aiqe_ssrc_data_v1 - api to setup SSRC data for SSRC V1
 * @ctx: pointer to dspp information structure
 * @cfg: pointer to sde_hw_cp_cfg payload
 * @mdnie_top: Pointer to top level mdnie structure
 */
void sde_setup_aiqe_ssrc_data_v1(struct sde_hw_dspp *ctx, void *cfg, void *mdnie_top);
