...
struct sde_encoder_phys_ops {
	...
	int (*control_empulse_irq)(struct sde_encoder_phys *enc, bool enable, bool acquire_lock);
 ...
 * @INTR_IDX_ESYNC_VSYNC:   Esync Vsync interrupt for video mode panel.
 * @INTR_IDX_PANEL_VSYNC:   Panel Vsync interrupt.
 * @INTR_IDX_ESYNC_MDP_VSYNC:  Esync MDP Vsync interrupt for video mode panel.
...
enum sde_intr_idx {
	...
	INTR_IDX_PANEL_VSYNC,
	INTR_IDX_ESYNC_MDP_VSYNC,
	INTR_IDX_CTL_START,
	INTR_IDX_CTL_DONE,
	INTR_IDX_RDPTR,
 ...
 * @pclk_ratio:     Ratio by which the display width is compressed for the
 *                  purpose of calculating pclk-related values, multiplied by 100
