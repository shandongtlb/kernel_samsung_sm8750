...
dtbo-$(CONFIG_ARCH_SUN)   += psq/sun-camera-sensor-psq-r00.dtbo \
				psq/sun-camera-sensor-psq-r01.dtbo \
				psq/sun-camera-sensor-psq-r02.dtbo \
				psq/sun-camera-sensor-psq-r03.dtbo \
				psq/sun-camera-sensor-psq-r04.dtbo \
				psq/sun-camera-sensor-psq-r05.dtbo \
				psq/sun-camera-sensor-psq-r06.dtbo \
				psq/sun-camera-sensor-psq-r07.dtbo \
				psq/sun-camera-sensor-psq-r08.dtbo \
				psq/sun-camera-sensor-psq-r09.dtbo \
				psq/sun-camera-sensor-psq-r10.dtbo \
				psq/sun-camera-sensor-psq-r11.dtbo \
				psq/sun-camera-sensor-psq-r12.dtbo \
				psq/sun-camera-sensor-psq-r13.dtbo \
				psq/sun-camera-sensor-psq-r14.dtbo \
				psq/sun-camera-sensor-psq-r15.dtbo
...
dtbo-$(CONFIG_ARCH_SUN)   += q7q/sun-camera-sensor-q7q-r00.dtbo \
				...
				q7q/sun-camera-sensor-q7q-r02.dtbo \
				q7q/sun-camera-sensor-q7q-r03.dtbo \
				q7q/sun-camera-sensor-q7q-r04.dtbo \
				q7q/sun-camera-sensor-q7q-r05.dtbo \
				q7q/sun-camera-sensor-q7q-r06.dtbo \
				q7q/sun-camera-sensor-q7q-r07.dtbo \
				q7q/sun-camera-sensor-q7q-r08.dtbo \
				q7q/sun-camera-sensor-q7q-r09.dtbo \
				q7q/sun-camera-sensor-q7q-r10.dtbo \
				q7q/sun-camera-sensor-q7q-r11.dtbo \
				q7q/sun-camera-sensor-q7q-r12.dtbo \
				q7q/sun-camera-sensor-q7q-r13.dtbo \
				q7q/sun-camera-sensor-q7q-r14.dtbo \
				q7q/sun-camera-sensor-q7q-r15.dtbo				
else ifneq ($(filter q7mq%, $(PROJECT_NAME)),)
dtbo-$(CONFIG_ARCH_SUN)   += q7mq/sun-camera-sensor-q7mq-r00.dtbo \
				q7mq/sun-camera-sensor-q7mq-r01.dtbo \
				q7mq/sun-camera-sensor-q7mq-r02.dtbo \
				q7mq/sun-camera-sensor-q7mq-r03.dtbo \
				q7mq/sun-camera-sensor-q7mq-r04.dtbo \
				q7mq/sun-camera-sensor-q7mq-r05.dtbo \
				q7mq/sun-camera-sensor-q7mq-r06.dtbo \
				q7mq/sun-camera-sensor-q7mq-r07.dtbo \
				q7mq/sun-camera-sensor-q7mq-r08.dtbo \
				q7mq/sun-camera-sensor-q7mq-r09.dtbo \
				q7mq/sun-camera-sensor-q7mq-r10.dtbo \
				q7mq/sun-camera-sensor-q7mq-r11.dtbo \
				q7mq/sun-camera-sensor-q7mq-r12.dtbo \
				q7mq/sun-camera-sensor-q7mq-r13.dtbo \
				q7mq/sun-camera-sensor-q7mq-r14.dtbo \
				q7mq/sun-camera-sensor-q7mq-r15.dtbo
else
