...
ifneq (,$(findstring q7m,$(TARGET_PRODUCT)))
PRODUCT_COPY_FILES += vendor/qcom/opensource/display-core/config/sdm_display_resolution_extn_Q7M.xml:$(TARGET_COPY_OUT_VENDOR)/etc/display/sdm_display_resolution_extn.xml
else
