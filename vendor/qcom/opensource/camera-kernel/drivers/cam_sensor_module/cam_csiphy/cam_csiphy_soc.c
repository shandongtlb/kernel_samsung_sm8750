...
#if defined(CONFIG_SEC_NE1Q_PROJECT) || defined(CONFIG_SEC_PA1Q_PROJECT)
#include "include/cam_csiphy_2_3_0_hwreg_pa1.h"
#elif defined(CONFIG_SEC_NE2Q_PROJECT) || defined(CONFIG_SEC_PA2Q_PROJECT)
#include "include/cam_csiphy_2_3_0_hwreg_pa2.h"
#elif defined(CONFIG_SEC_NE3Q_PROJECT) || defined(CONFIG_SEC_PA3Q_PROJECT)
#include "include/cam_csiphy_2_3_0_hwreg_pa3.h"
#elif defined(CONFIG_SEC_PSQ_PROJECT)
#include "include/cam_csiphy_2_3_0_hwreg_ps.h"
#elif defined(CONFIG_SEC_Q7Q_PROJECT) || defined(CONFIG_SEC_Q7MQ_PROJECT)
#include "include/cam_csiphy_2_3_0_hwreg_q7.h"
#else
