...
class Platform {
  ...
  public:
    ...
    */
...
#endif
#ifdef SEC_AUDIO_BLE_OFFLOAD
    void setBleNrecState(const bool& isOn) noexcept { ble_nrec = isOn; }
    bool isBleNrecOn() const noexcept { return ble_nrec; }
#endif
#ifdef SEC_AUDIO_SUPPORT_BT_RVC
    ...
    bool getConcurrentCapture() const noexcept;
#endif
#ifdef SEC_AUDIO_INTERPRETER_MODE
