...
#define DMIC_CLK_2_4_MZ 0x5
#define DMIC_CLK_3_2_MZ 0x3
#define DMIC_CLK_0_6_MZ 0xb
...
int sec_audio_debug_rx_status_check(struct _rx_debug_info *debug_info, int amp_index);
