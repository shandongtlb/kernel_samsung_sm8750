...
static ssize_t get_cur_state_show(const struct class *class,
...
static ssize_t set_cur_state_store(const struct class *class,
			const struct class_attribute *attr,
...
static ssize_t state_list_show(const struct class *class,
			const struct class_attribute *attr,
			char *buf)
{
	struct qmi_cooling_device *qmi_cdev;
...
static ssize_t clock_show(const struct class *class,
			const struct class_attribute *attr,
			char *buf)
{
	char list[30] = {0, };
...
static ssize_t clock_table_show(const struct class *class,
			const struct class_attribute *attr,
			char *buf)
{
	char list[100] = {0, };
...
static ssize_t time_in_state_show(const struct class *class,
			const struct class_attribute *attr,
			char *buf)
{
	char list[500] = {0, };
