...
#define MSG_SEQ_FOLD_MON_MAX 12
#endif
#if IS_ENABLED(CONFIG_SUPPORT_ANALOG_HALL_FACTORY)
#define MSG_ANALOG_HALL_MAX (MSG_SEQ_FOLD_MON_MAX)
#endif
#if IS_ENABLED(CONFIG_SUPPORT_VIRTUAL_MAG)
#define MSG_VMAG_MAX	1
#endif
...
#endif
#if IS_ENABLED(CONFIG_SUPPORT_ANALOG_HALL_FACTORY)
	MSG_ANALOG_HALL = MSG_SEQ_FOLD_MON,
#endif
...
#define SENSOR_HANDLE_ACCELEROMETER_SUB2               (65701)
#endif
...
enum {
	...
	COMMON_DATA_SET_LCD_INTENT_BY_PROX_ON = 0xf3,	// 0xf3 00 47 C1
	COMMON_DATA_SET_LCD_INTENT_BY_PROX_OFF,		// 0xf4 00 47 C1
};
...
enum {
	...
	DEVICE_MODE_RESERVED_FOR_MAIN_FLIP_HALL = 60,
	DEVICE_MODE_RESERVED_FOR_SUB_FLIP_HALL = 61,
	DEVICE_MODE_RESERVED_FOR_MPP_COVER = 62, // MPP cover
	DEVICE_MODE_MAX= 63,
};
...
struct sns_smp2p_values {
	...
	int connect_id;
	bool is_fac;
	bool is_sns_reserved_id;
	bool is_awaking_event;
	bool is_log_enable;
};
